...
$form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		 <?php 
		 echo $form->labelEx($model,'tgl_dibayar'); ?>
		  <?php 
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'Nilai kontrak',array('value'=>$penghuni['nilai_kontrak'],'disabled'=>true,'id'=>'nk')); ?>
		<?php echo $form->error($model,'Nilai kontrak'); ?>
	</div>
	
	<div class="row">
		<?php echo $form->labelEx($model,'Nilai bayar'); ?>
	...
	<div class="row" style="display:none">
		<?php// echo $form->textField($model,'nilai_bayar',array('value'=>$penghuni['nilai_kontrak'])); ?>
	</div>
