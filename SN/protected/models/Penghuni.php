...
class Penghuni extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nilai_kontrak', 'numerical', 'integerOnly'=>true,'allowEmpty'=>false),
			array('id_pelanggan, jenis_bayar', 'length', 'max'=>20,'min'=>1,'allowEmpty'=>false),
			array('id_kamar, status', 'length', 'max'=>10,'min'=>1),
			array('tgl_masuk', 'date','format'=>'yyyy-M-d','allowEmpty'=>false),
			//array('tgl_keluar','date','format'=>'yyyy-M-d','allowEmpty'=>true),
