...
class PenggunaController extends CController
{
        public $breadcrumbs;
	/**
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Pengguna']))
		{
                       ...
                       if (!empty($model->hak_akses)) $criteria->addCondition('hak_akses = "'.$model->hak_akses.'"');
                     
                    			
		}
                 $session['Pengguna_records']=Pengguna::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Pengguna_records']))
               {
                $model=$session['Pengguna_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Pengguna Report');
		$pdf->SetSubject('Pengguna Report');
