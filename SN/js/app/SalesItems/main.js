...
function print_rekap(data) {
    ...
    if (applet != null) {
        ...
        applet.append("\n");
		applet.append(data.detail.gross2);
        // applet.append("\n");
		applet.append(data.detail.grossvalue2);
        applet.append("\n");
...
function add_item()
{
    $.ajax({
        ...
        success : function(data)
        {
            ...
            var service_new = $("#service").val();//var service via table
            service  = 	service_new * (subtotal-discount)/ 100;
